...
{
    public class Infusion2RemoveInfusionSelectionWindow : SearchableSelectionWindow<Def>
    {
        private const string SearchControlNameConst = "CheatMenu.Infusion2.RemoveInfusion.SearchField";
        private readonly Action<Def> onSelected;
        private readonly List<Def> options;

        public Infusion2RemoveInfusionSelectionWindow(List<Def> options, Action<Def> onSelected)
        ...
        protected override string TitleKey => "CheatMenu.Infusion2.RemoveInfusion.Window.Title";

        protected override string SearchTooltipKey => "CheatMenu.Infusion2.RemoveInfusion.Window.SearchTooltip";

        protected override string SearchControlName => SearchControlNameConst;

        protected override string NoMatchesKey => "CheatMenu.Infusion2.RemoveInfusion.Window.NoMatches";

        protected override string SelectButtonKey => "CheatMenu.Infusion2.RemoveInfusion.Window.SelectButton";
