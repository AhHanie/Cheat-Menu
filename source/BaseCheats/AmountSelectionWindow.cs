...
namespace Cheat_Menu
{
    public class AmountSelectionWindow : Window
    {
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            Widgets.Label(sliderValueRect, "CheatMenu.AmountWindow.CurrentValue".Translate(amount, maxAmount));
        ...
        private void DrawAmountControls(Rect rect)
        {
            ...
            Widgets.Label(labelRect, "CheatMenu.AmountWindow.AmountLabel".Translate());
