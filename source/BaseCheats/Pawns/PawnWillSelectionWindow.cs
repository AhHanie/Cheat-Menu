...
{
    public class PawnWillSelectionWindow : Window
    {
        ...
        public PawnWillSelectionWindow(
            string titleKey,
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            Widgets.Label(sliderValueRect, "CheatMenu.PawnWill.Window.CurrentValue".Translate(amount));
        ...
        private void DrawAmountControls(Rect rect)
        {
            ...
            Widgets.Label(labelRect, "CheatMenu.PawnWill.Window.AmountLabel".Translate());
